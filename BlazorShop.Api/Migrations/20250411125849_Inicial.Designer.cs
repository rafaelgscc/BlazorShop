...
namespace BlazorShop.Api.Migrations
{
    ...
    [Migration("20250411125849_Inicial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlazorShop.Api.Enitites.Carrinho", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BlazorShop.Api.Enitites.CarrinhoItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BlazorShop.Api.Enitites.Categoria", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BlazorShop.Api.Enitites.Produto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BlazorShop.Api.Enitites.Usuario", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BlazorShop.Api.Enitites.CarrinhoItem", b =>
                {
                    b.HasOne("BlazorShop.Api.Enitites.Carrinho", "Carrinho")
                        .WithMany("Itens")
                        .HasForeignKey("CarrinhoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BlazorShop.Api.Enitites.Produto", "Produto")
                        .WithMany("Itens")
            ...
            modelBuilder.Entity("BlazorShop.Api.Enitites.Produto", b =>
                {
                    b.HasOne("BlazorShop.Api.Enitites.Categoria", "Categoria")
                        .WithMany("Produtos")
